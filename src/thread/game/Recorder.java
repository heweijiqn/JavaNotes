...
public class Recorder {
    ...
    //把记录文件保存到 src 下的 record.txt 文件中
    ...
    public static void setEnemyTanks(Vector<EnemyTank> enemyTanks) {  //设置敌人坦克Vector
    ...
    //该方法，在继续上局的时候调用即可
    public static Vector<Node> getNodesAndEnemyTankRec() {  //读取recordFile, 恢复相关信息
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Node node = new Node(Integer.parseInt(xyd[0]), Integer.parseInt(xyd[1]),
                        Integer.parseInt(xyd[2]));  //生成一个Node对象  并加入到nodes集合中  参数分别是 x, y, direct
    ...
    public static void keepRecord() {  //保存敌人坦克的坐标和方向
        try {
