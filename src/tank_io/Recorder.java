...
public class Recorder {
    ...
    public static void setEnemyTanks(Vector<EnemyTank> enemyTanks) {  //将myPanel的敌人坦克Vector传递过来
    ...
    public static Vector<Node> getNodesAndEnemyTankRec() {
        ...
        try {
            ...
            allEnemyTankNum = Integer.parseInt(br.readLine());   //读取第一行，获取敌人坦克数量 allEnemyTankNum
            //循环读取文件，生成nodes 集合
